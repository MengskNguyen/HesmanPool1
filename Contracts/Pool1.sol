...
contract Pool1 is Ownable, ReentrancyGuard {
    ...
    modifier ValidUnStakeTime() {
        require(block.timestamp >= unStakeTimeStart, "Invalid unstake time");
        _;
    } 
    ...
    // Staking BAMI
    function stakeBamiToken() external nonReentrant isNotPaused validStakingTime hasNotStaked isNotOutOfSlot hasEnoughBamiTokenToStake  {
    ...
    // --------- MUA SLOT --------- //
    function buySlot() external nonReentrant isNotPaused validBuySlotTime isNotOutOfSlot hasStaked hasNotBoughtSlot hasEnoughBUSDTokenToBuySlot hasEnoughBamiTokenToBuySlot {
    ...
    function claimHesman() nonReentrant isNotPaused hasBoughtSlot external {
    ...
    function withdrawStakedBamiToken() nonReentrant isNotPaused ValidUnStakeTime hasStaked public {
